...
namespace bsn.CommandLine.Context {
	internal abstract class CollectionCommandBase<TExecutionContext, TItem>: ActionCommandBase<TExecutionContext, TItem> where TExecutionContext: class, IExecutionContext<TExecutionContext>
