...
namespace bsn.CommandLine.Context {
	internal class CollectionDeleteActionCommand<TExecutionContext, TItem>: CommandActionCommandBase<TExecutionContext, TItem> where TExecutionContext: class, IExecutionContext<TExecutionContext>
	                                                                                                                           where TItem: class, ICollectionDelete<TExecutionContext> {
