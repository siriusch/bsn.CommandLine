...
namespace bsn.CommandLine.Context {
	internal class ConfigurationSetActionCommand<TExecutionContext, TItem>: CommandActionCommandBase<TExecutionContext, TItem> where TExecutionContext: class, IExecutionContext<TExecutionContext>
	                                                                                                                           where TItem: class, IConfigurationWrite<TExecutionContext> {
