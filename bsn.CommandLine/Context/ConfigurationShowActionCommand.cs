...
namespace bsn.CommandLine.Context {
	internal class ConfigurationShowActionCommand<TExecutionContext, TItem>: CommandActionCommandBase<TExecutionContext, TItem> where TExecutionContext: class, IExecutionContext<TExecutionContext>
	                                                                                                                            where TItem: class, IConfigurationRead<TExecutionContext> {
